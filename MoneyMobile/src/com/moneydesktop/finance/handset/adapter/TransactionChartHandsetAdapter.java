...
public class TransactionChartHandsetAdapter extends TransactionChartAdapter {
    ...
    /**
     * Take the data for the report and put it into a {@link com.moneydesktop.finance.views.barchart.BarViewModel} to aid in displaying
     * it in the bar chart view.
     *
     * @param popupFormat The date format for the popup view
     * @param labelFormat The date format for the label on the {@link com.moneydesktop.finance.views.barchart.BarView}
