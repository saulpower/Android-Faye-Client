...
import com.moneydesktop.finance.database.BankDao.Properties;
import org.json.JSONObject;
// KEEP INCLUDES END
/**
 * Entity mapped to table BANK.
 */
public class Bank implements BusinessObjectInterface {
    ...
    public static Bank getBank(String bankId) {
    	...
    	List<Bank> banks = bankDao.queryBuilder().where(Properties.BankId.eq(bankId)).list();
    ...
    public static Bank createObject(JSONObject json) {
