    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BANK_ACCOUNT' (" + //
                ...
                "'BANK_ACCOUNT_ID' INTEGER," + // 23: bankAccountId
                "'BUSINESS_OBJECT_ID' INTEGER NOT NULL ," + // 24: businessObjectId
                "'ACCOUNT_TYPE_ID' INTEGER," + // 25: accountTypeId
                "'SUB_ACCOUNT_TYPE_ID' INTEGER);"); // 26: subAccountTypeId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, BankAccount entity) {
        ...
        if (bankAccountId != null) {
            stmt.bindLong(24, bankAccountId);
        }
        stmt.bindLong(25, entity.getBusinessObjectId());
 
        Long accountTypeId = entity.getAccountTypeId();
        if (accountTypeId != null) {
            stmt.bindLong(26, accountTypeId);
        }
 
        Long subAccountTypeId = entity.getSubAccountTypeId();
        if (subAccountTypeId != null) {
            stmt.bindLong(27, subAccountTypeId);
        }
    }
    ...
    public BankAccount readEntity(Cursor cursor, int offset) {
        BankAccount entity = new BankAccount( //
            ...
            cursor.isNull(offset + 23) ? null : cursor.getLong(offset + 23), // bankAccountId
            cursor.getLong(offset + 24), // businessObjectId
            cursor.isNull(offset + 25) ? null : cursor.getLong(offset + 25), // accountTypeId
            cursor.isNull(offset + 26) ? null : cursor.getLong(offset + 26) // subAccountTypeId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, BankAccount entity, int offset) {
        ...
        entity.setBankAccountId(cursor.isNull(offset + 23) ? null : cursor.getLong(offset + 23));
        entity.setBusinessObjectId(cursor.getLong(offset + 24));
        entity.setAccountTypeId(cursor.isNull(offset + 25) ? null : cursor.getLong(offset + 25));
        entity.setSubAccountTypeId(cursor.isNull(offset + 26) ? null : cursor.getLong(offset + 26));
     }
    ...
    public List<BankAccount> _queryBank_BankAccounts(Long bankAccountId) {
        synchronized (this) {
        ...
        Query<BankAccount> query = bank_BankAccountsQuery.forCurrentThread();
        query.setParameter(0, bankAccountId);
        return query.list();
    }

    /** Internal query to resolve the "bankAccounts" to-many relationship of AccountType. */
    public List<BankAccount> _queryAccountType_BankAccounts(Long accountTypeId) {
        synchronized (this) {
            if (accountType_BankAccountsQuery == null) {
                QueryBuilder<BankAccount> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.AccountTypeId.eq(null));
                accountType_BankAccountsQuery = queryBuilder.build();
            }
        }
        Query<BankAccount> query = accountType_BankAccountsQuery.forCurrentThread();
        query.setParameter(0, accountTypeId);
        return query.list();
    }
