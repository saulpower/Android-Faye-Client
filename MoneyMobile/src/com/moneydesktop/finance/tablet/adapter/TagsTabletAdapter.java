...
public class TagsTabletAdapter extends DeleteBaseAdapter<Tag> implements Filterable {
    ...
    public TagsTabletAdapter(PopupTabletActivity activity, int resourceId, List<Tag> tags, ListView listView, ClearEditText search) {
        super(activity, resourceId, tags, listView);

        mActivity = activity;
        
        long id = mActivity.getIntent().getLongExtra(Constant.EXTRA_BOB_ID, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (cell == null) {
            ...
            cell = mActivity.getLayoutInflater().inflate(R.layout.tablet_tag_item, parent, false);
