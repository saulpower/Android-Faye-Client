...
public class Constant {
    ...
    public static final String QUERY_DAILY_TRANSACTIONS = "SELECT DATE, SUM(AMOUNT) AS Amount FROM TRANSACTIONS WHERE %s AND DATE BETWEEN ? AND ? GROUP BY DATE ORDER BY DATE ASC";
    /*******************************************************************
     * VALUES
     *******************************************************************/
