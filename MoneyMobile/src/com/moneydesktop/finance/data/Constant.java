...
public class Constant {
    ...
    public static final String QUERY_TRANSACTIONS_TOTAL = "SELECT SUM(AMOUNT) AS Amount FROM TRANSACTIONS";
    public static final String QUERY_CATEGORY_TOTAL = "SELECT SUM(T.AMOUNT) AS Amount FROM TRANSACTIONS T JOIN CATEGORY C ON T.CATEGORY_ID = C._ID WHERE C._ID = ? OR C.PARENT_CATEGORY_ID = ?";
