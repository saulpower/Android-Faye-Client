...
public class SmallSpinnerView extends ImageView {
    ...
    public SmallSpinnerView(Context context) {
        super(context);

        load(context);
    }

    public SmallSpinnerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        load(context);
    }

    public SmallSpinnerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void load(Context context) {
        ...
        loadAnimation("phone_loading_small", 8);
        startAnimation();
    }
