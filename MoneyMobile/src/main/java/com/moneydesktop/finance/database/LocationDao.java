    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'LOCATION' (" + //
                ...
                "'STATE' TEXT," + // 9: state
                "'STREET_ADDRESS' TEXT," + // 10: streetAddress
    ...
    protected void bindValues(SQLiteStatement stmt, Location entity) {
        ...
        if (streetAddress != null) {
            stmt.bindString(11, streetAddress);
        }
    ...
    public Location readEntity(Cursor cursor, int offset) {
        Location entity = new Location( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // streetAddress
    ...
    public void readEntity(Cursor cursor, Location entity, int offset) {
        ...
        entity.setStreetAddress(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
