...
public abstract class UltimateAdapter extends BaseExpandableListAdapter
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        View res = getItemView(groupPosition, childPosition, isLastChild,
                convertView, parent);
        res.requestLayout();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        View res = getSectionView(groupPosition, isExpanded, convertView,
                parent);
        res.requestLayout();
    ...
    public void onGroupExpanded(int groupPosition) {
        ...
        if (mExpanded == null || mExpanded.length < getGroupCount()) {
            mExpanded = new boolean[getGroupCount()];
        }

        initializeLoaded();

        if (mAutomaticSectionLoading && !mLoaded[groupPosition]
                && !mLoading[groupPosition]) {
    ...
    /**
     * The section is requested to be seen, so do the request and call
     * {@link UltimateListView#tellNoMoreData()} if there is no more pages.
     *
     * @param section
     *            the section number to load.
     */
     ...
     * read: get view too
     */
    public abstract View getItemView(int groupPosition, int childPosition,
            boolean isLastChild, View convertView, ViewGroup parent);

    public abstract View getSectionView(int groupPosition, boolean isExpanded,
            View convertView, ViewGroup parent);
