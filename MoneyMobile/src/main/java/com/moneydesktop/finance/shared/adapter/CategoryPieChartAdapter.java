...
import main.java.com.moneydesktop.finance.views.piechart.BaseExpandablePieChartAdapter;
import main.java.com.moneydesktop.finance.views.piechart.InfoDrawable;
import main.java.com.moneydesktop.finance.views.piechart.PieChartView;
import main.java.com.moneydesktop.finance.views.piechart.PieSliceDrawable;
...
public class CategoryPieChartAdapter extends BaseExpandablePieChartAdapter {
    ...
    public CategoryPieChartAdapter(Context context) {
        ...
        mOtherName = context.getString(R.string.label_others);
    ...
    private void loadCategories() {
        ...
        new AsyncTask<Integer, Void, List<Pair<Category, List<Category>>>>() {
            ...
            protected List<Pair<Category, List<Category>>> doInBackground(Integer... params) {
                ...
                other.setCategoryName(mOtherName);
                ...
                while (mTotal == 0f) {
                    ...
                    for (Pair<Category, List<Category>> parent : categories) {
                        mTotal += Category.getTotalForCategory(parent.first, mRange);
                    }

                    if (mTotal == 0f) {
                        mTotal = 0f;
                        mRange.addMonthsToStart(count);
                        count--;
                    }
                }
                ...
                for (Pair<Category, List<Category>> parent : categories) {
                    ...
                    float categoryTotal = Category.getTotalForCategory(parent.first, mRange);
                    ...
                    for (Category category : parent.second) {
                        ...
                        float childTotal = Category.getTotalForChildCategory(category, mRange);
    ...
    public List<Category> getAllChildren(int groupPosition) {
        return mCategories.get(groupPosition).second;
    }
    ...
    public int getChildColor(int groupPosition, int childPosition) {
        ...
        if (groupPosition == (getGroupCount() - 1) && group.getCategoryName().equals(mOtherName)) {
