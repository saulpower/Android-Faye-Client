...
public class BusinessObjectBase {
    ...
    public BusinessObjectBase(Long id, String externalId, Integer dataState, java.util.Date dateModified, String errorCode, Integer flags, String primaryKey, String toString, Integer version) {
        this.id = id;
