...
public class Bank {
    ...
    public Bank(Long id, String bankName, java.util.Date dateCreated, String defaultClassId, String deleteAction, Boolean isLinked, java.util.Date lastRefreshDate, String logoId, Integer processStatus, Integer status, String statusDescription, Integer statusFlags, String statusInstructions, long institutionId) {
        this.id = id;
    ...
    public void setInstitution(Institution institution) {
        if (institution == null) {
            throw new DaoException("To-one property 'institutionId' has not-null constraint; cannot set to-one to null");
        }
