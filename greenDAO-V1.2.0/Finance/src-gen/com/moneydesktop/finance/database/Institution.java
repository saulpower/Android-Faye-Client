...
public class Institution {
    ...
    public Institution(Long id, java.util.Date createdOn, String instructions, String name, String phone, Integer popularity, Integer status, java.util.Date updatedOn, String url) {
        this.id = id;
