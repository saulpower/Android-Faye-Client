...
public class BusinessObjectBaseDao extends AbstractDao<BusinessObjectBase, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property DataState = new Property(2, Integer.class, "dataState", false, "DATA_STATE");
        public final static Property DateModified = new Property(3, java.util.Date.class, "dateModified", false, "DATE_MODIFIED");
        public final static Property ErrorCode = new Property(4, String.class, "errorCode", false, "ERROR_CODE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'BUSINESS_OBJECT_BASE' (" + //
                ...
                "'DATA_STATE' INTEGER," + // 2: dataState
                "'DATE_MODIFIED' INTEGER," + // 3: dateModified
                "'ERROR_CODE' TEXT," + // 4: errorCode
    ...
    public BusinessObjectBase readEntity(Cursor cursor, int offset) {
        BusinessObjectBase entity = new BusinessObjectBase( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // dataState
            cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)), // dateModified
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // errorCode
    ...
    public void readEntity(Cursor cursor, BusinessObjectBase entity, int offset) {
        ...
        entity.setDataState(cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2));
        entity.setDateModified(cursor.isNull(offset + 3) ? null : new java.util.Date(cursor.getLong(offset + 3)));
        entity.setErrorCode(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
