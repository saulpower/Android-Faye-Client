...
public class Transaction {
    ...
    public void setParent(Transaction parent) {
        if (parent == null) {
            throw new DaoException("To-one property 'parentTransactionId' has not-null constraint; cannot set to-one to null");
        }
        this.parent = parent;
